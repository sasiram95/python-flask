...
def create_zip(random_hex):
    zf = zipfile.ZipFile("static/ZipFiles/"+random_hex+".zip", "w")
    for dirname, subdirs, files in os.walk('static/SplitDocument/'+random_hex):
        zf.write(dirname)
